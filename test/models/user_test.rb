...
test "feed should have the right posts" do
  ...
  lana.microposts.each do |post_following|
      assert tranecia.feed.include?(post_following)
  end
# Posts from self
  tranecia.microposts.each do |post_self|
    assert tranecia.feed.include?(post_self)
  end
  # Posts from unfollowed user
  archer.microposts.each do |post_unfollowed|
    assert_not tranecia.feed.include?(post_unfollowed)
  end
 end
end
